...
public class ErrorMessages {
    ...
    public static final String PASSWORD_NOT_MATCHED = "Your old passwords are not matched";
    ...
    public static final String NOT_FOUND_USER_MESSAGE = "Error: User not found with user id %s";
    ...
    public static final String NOT_FOUND_LESSON_PROGRAM_MESSAGE = "Error : Lesson Program with this field %s is not found";
