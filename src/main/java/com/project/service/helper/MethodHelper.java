...
public class MethodHelper {
    ...
    //!!! role kontrolü yapan metod
    public void checkRole(User user, RoleType roleType){
        if (!user.getUserRole().getRoleType().equals(roleType)){
            throw new ConflictException(String.format(ErrorMessages.NOT_FOUND_USER_WITH_ROLE_MESSAGE,user.getId(),roleType.name()));
        }
    }
    ...
    //!!! Gelen User, Advisor mı kontrolü
