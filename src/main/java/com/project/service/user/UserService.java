...
public class UserService {
    ...
    public ResponseMessage<UserResponse> saveUser(UserRequest userRequest, String userRole) {
        ...
        //!!! Girilen username, email, phoneNumber, ssn unique mi kontrolü
        ...
        //!!! isAdvisor değerini False yapıyoruz
    ...
    public String deleteUserById(Long id, HttpServletRequest request) {
        ...
        //!!! silinecek olan user var mı? kontrolü
        User user = methodHelper.isUserExist(id);
        //!!! metodu tetikleyen kullanıcının rol bilgisini alıyoruz
...
//!!! builtIn ve Role kontrolu
    ...
    public ResponseEntity<String> updateUserForUsers(UserRequestWithoutPassword userRequest,
        ...
        String message = SuccessMessages.USER_UPDATED_MESSAGE;
