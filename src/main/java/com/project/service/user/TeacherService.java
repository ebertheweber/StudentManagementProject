...
public class TeacherService {
    ...
    public ResponseMessage<TeacherResponse> updateTeacherForManagers(TeacherRequest teacherRequest, Long userId) {
        ...
        //!!! parametrede gelen User gerçekten Teacher mı kontrolü
        ...
        //!!! TODO : LessonProgramlar setlencek
    ...
    public ResponseMessage<UserResponse> saveAdvisorTeacher(Long teacherId) {
        ...
        //!!! id ile gelen teacher zaten advisor mı kontrolü
        ...
        return ResponseMessage.<UserResponse>builder()
                .message(SuccessMessages.ADVISOR_TEACHER_UPDATED)
    ...
    public ResponseMessage<UserResponse> deleteAdvisorTeacherById(Long id) {
        ...
        //!!! silinen rehber ogretmenin ogrencileri varsa bu ilsikiyi koparmamiz gerekiyor
