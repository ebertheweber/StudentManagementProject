...
public class ContactMessageController {
    ...
    @GetMapping("/searchBetweenTimes")//http:localhost:8080/contactMessages/searchBetweenTimes   + GET
    public ResponseEntity<List<ContactMessage>> searchBetweenTimes(
        ...
        List<ContactMessage> contactMessages = contactMessageService
                .searchBetweenTimes(startHourString,startMinuteString,endHourString,endMinuteString);
        return ResponseEntity.ok(contactMessages);
    }
