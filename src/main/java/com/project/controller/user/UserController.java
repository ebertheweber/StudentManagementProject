...
public class UserController {
    ...
    //!!! Save --> Teacher ve Student dışındakiler için
    ...
    //!!! Müdür ve Müdür Yrd ise altındaki rol yetkisi olanı silebilsin
    ...
    //Update
    //!!! Admin--> Dean veya ViceDean'i güncellerken kullanılacak method
    //!!! Student ve teacher için ekstra fieldlar gerekeceği için, başka endpoint gerekiyor
    @PutMapping("/update/{userId}") // http://localhost:8080/user/update/2 + PUT + JSON
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    ...
    //Update
    //!!! Kullanıcının kendisini update etmesini sağlayan method
