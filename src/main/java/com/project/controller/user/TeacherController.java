...
public class TeacherController {
    ...
    @PostMapping("/update/{userId}") // http://localhost:8080/teacher/update/1 + PUT + JSON
    ...
    @GetMapping("/getAllAdvisorTeacher") // http://localhost:8080/teacher/getAllAdvisorTEeacher
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
