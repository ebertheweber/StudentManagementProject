...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(auuthenticationJwtTokenFilter(), UsernamePasswordAuthenticationFilter.class);

        return http.build();
    }

    @Bean
    public AuthTokenFilter auuthenticationJwtTokenFilter(){
    ...
    public WebMvcConfigurer corsConfigurer(){
        ...
        return new WebMvcConfigurer() {
            //addCorsMapping adlı bir metodu override ediyoruz, yani
            // bu metodun içini doldurarak CORS ayarlarını özelleştirebiliiz.
            @Override
